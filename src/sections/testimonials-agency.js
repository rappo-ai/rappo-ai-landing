...
import quote from 'assets/testimonial-agency/quote.png';
import uber from 'assets/testimonial-agency/logos/uber.png';
import google from 'assets/testimonial-agency/logos/google.png';
import paypal from 'assets/testimonial-agency/logos/paypal.png';
import microsoft from 'assets/testimonial-agency/logos/microsoft.png';
import dribbble from 'assets/testimonial-agency/logos/dribbble.png';
...
const TestimonialsAgency = () => {
  return (
    <Box as="section" id="testimonialsAgency" sx={styles.section}>
      <Container>
        <Tabs
          sx={styles.tabs}
...
export default TestimonialsAgency;
